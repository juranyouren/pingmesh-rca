...
\NKTsetup{%
  论文题目(中文) = 面向大规模数据中心的拓扑网络关联事件根因定位,
  %论文题目(中文)(第二行) =第二行中文题目，填无则不显示本行,
  论文题目(中文)(第二行) = 无,
  论文题目(英文) =  Root Cause Analysis for Topology-Aware Incidents ,
  论文题目(英文)(第二行) = in Large-Scale Datacenters,
  % 论文题目(英文)(第二行) =无,
  学号           = 2213130,
  姓名          = 李昕杨,
  年级          = 2022,
