...
from Sys.RootCauseAnalyze.stage1.fusion import (
    _combine_scores,
    ...
    for dirpath, _dirnames, filenames in os.walk(data_root):
        ...
        try:
            ...
            mock_response = json.dumps(
                {
                    "reasoning": f"Deterministic Stage 1 pipeline ({mode_desc}), branches={list(skill_ids)}.",
                    "ip": predicted_ips,
            ...
            results.append(
                {
                    ...
                    "skill_details": details,
                    "stage1": {
                        "method": "parallel_temporal_and_alarm_topology_evidence_ranking",
...
# Keep the historical function name for existing experiment callers.
run_skill_pipeline = run_stage1_pipeline
