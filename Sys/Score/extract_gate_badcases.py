...
This evaluation-only utility reads labels after inference has materialized
``res.json``. The runtime RCA path never imports this module.

Example:
    python Sys/Score/extract_gate_badcases.py \
