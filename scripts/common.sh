...
# RQ1: paths inherit the common dataset/GT/results settings. Optional frozen
# manifest/groups/shared roots override automatic preparation when available.
