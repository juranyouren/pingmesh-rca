...
用法:
    python Sys_v1/Score/evaluate_gate_selection.py --res <res.json> --out-dir <dir>
"""
...
from Sys_v1.Score.score_utils import case_id_from_dir, dedupe, load_json, write_json, write_jsonl
